...
// 2. Implement "filterAddresses" function.
...
// 3. Implement "isValidAddress" function.

const isValidAddress = (employee: Pick<Employee, 'street'>): boolean => (
  !isNil(employee.street)
)

// 4. Cleanup the database.

function filterEmployeeRecords (collection: Employee[]): Employee[] {
  return filterAddresses(collection, isValidAddress)
}

filterEmployeeRecords(database)
